  ...
  <div class="home">
    ...
    <div class="center-box w padding">
      ...
      <div class="cente-text mg-bottom">
        ...
        本次研讨会为来自世界各地的研究人员、实践者和行业专家提供了交流平台，让大家分享新思想、交流研究发现、并讨论预训练的LLMs在金融服务领域中面临的挑战和机遇。研讨会将涵盖两个主题：1）预训练的LLMs在金融服务中的潜在应用和最佳实践；2）需要解决的挑战，提升使预训练的LLMs效率、效果及可信度。
        <br /><br />
        研讨会还将邀请领先的研究人员和行业专家发表演讲，并就该领域的最新趋势和挑战进行小组讨论。我们欢迎来自学术界和行业的研究人员、实践者和行业专家提交他们的工作，并参与这个令人兴奋的活动。
      </div>
      <h1>论文征集启事</h1>
      <div class="cente-text mg-bottom">
      ...
      <div class="cente-text mg-bottom">
        <div class="cente-text-cente justify">
          论文需按照IJCAI'23的格式提交，包括图表在内最少4页、最多7页，允许添加额外的页面列举引用的参考文献。我们接受近期已发表的或正在接受审查的论文提交。论文应当包含作者的详细信息。研讨会将不会有正式的论文集，但被接受的论文作者可以选择在研讨会网页上发表他们的工作。从研讨会中选出的最佳论文将被邀请发表在IJCAI的期刊特刊中。
          <br /><br />
